...
- The local [MCX-128 cassette-loading fault analysis](mcx-cassette-loading.md) separates the physical `$5000` RAM mapping from XRoar's synthetic auto-keyboard failure.
