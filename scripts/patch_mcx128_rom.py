...
# keyboard and leaves the selected menu value in A. Replace that poll with
# A=1, then branch to the common copy/initialisation path at $C0A2. In the
# firmware's selector, 0=standard MCX BASIC, 1=large MCX BASIC, and 2=stock
# MicroColor BASIC. The remaining bytes are NOPs in the unused poll span.
PATCH_OFFSET = 0x008D
ORIGINAL = bytes.fromhex(
    "CC FE 10 97 02 0D 4C F5 BF FF 27 05 79 00 02 25 F5 81 02 2C EB"
)
PATCHED = bytes.fromhex("86 01 20 11") + bytes([0x01]) * 17
