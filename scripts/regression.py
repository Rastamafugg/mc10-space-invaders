...
def check_artifacts(root: Path, build_dir: Path) -> None:
    ...
    calibrator_tokens = (
        ...
        "CAL_SWEEP_ACTIVE",
        "CAL_SWEEP_OFFSET",
        "CAL_SWEEP_OFFSET_MIN",
        "CAL_SWEEP_OFFSET_MAX",
        "CAL_SWEEP_HEIGHT_STATE",
        "CAL_BAND_HEIGHT",
        "CAL_MANUAL_PHASE_STEP",
        "CAL_SWEEP_START",
        "CAL_SWEEP_END",
    ...
    mame_harness_tokens = (
        ...
        "PHASE_WAIT_SWEEP",
        "PHASE_WAIT_PAUSE",
        "PHASE_WAIT_RESIZE_DOWN",
        "PHASE_WAIT_RESIZE_UP",
        "PHASE_WAIT_MOVE_UP",
        "PHASE_WAIT_MOVE_DOWN",
        "PHASE_WAIT_OFFSCREEN_BOTTOM",
        "PHASE_WAIT_OFFSCREEN_BOTTOM_START",
        "PHASE_WAIT_OFFSCREEN_TOP",
        "PHASE_WAIT_OFFSCREEN_TOP_START",
        "CAL_SWEEP_HEIGHT_STATE",
        "CAL_SWEEP_OFFSET",
        "sweep-height-small",
        "sweep-move-up",
        "sample_cg3_background",
        "machine:exit()",
    ...
    mame_game_harness_tokens = (
        ...
        'screen:snapshot("mame-game-restart.png")',
        'post_game_key("A",',
        'post_game_key("D",',
        'post_game_key("{SPACE}",',
        "GAME_FRAME",
